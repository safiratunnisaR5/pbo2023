...
class FormPerawat:
    ...
    def onSimpan(self, event=None):
        ...
        # Check if NIP is already in the database
        existing_data = perawat.getByNIP(nip)
        if existing_data:
            # Data already exists, show a warning
            messagebox.showwarning("showwarning", "Data dengan NIP tersebut sudah ada.")
            return
