...
from fungsi import hitung_luas_persegiPanjang, hitung_keliling_persegiPanjang

def hitung_luas():
    pj = float(txtpanjang.get())
    lb = float(txtlebar.get())

    L = hitung_luas_persegiPanjang(pj,lb)
...
def hitung_keliling():
    ...
    K = hitung_keliling_persegiPanjang(pj,lb)
...
# Tambahkan judul
app.title("Kalkulator Luas dan Keliling Persegi Panjang safiratun nisa")
