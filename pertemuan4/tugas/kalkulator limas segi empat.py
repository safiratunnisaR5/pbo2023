...
import math
from fungsi import hitung_luas_limas_segi_empat, hitung_volume_limas_segi_empat
...
def hitung_luas():
    ...
    luas = hitung_luas_limas_segi_empat(jari_jari, Tinggi)
...
def hitung_volume():
    ...
    Volume = hitung_volume_limas_segi_empat (jari_jari, Tinggi)
