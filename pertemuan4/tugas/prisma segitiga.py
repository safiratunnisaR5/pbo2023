...
from fungsi import hitung_luas_prisma_segitiga, hitung_luassisi_prisma_segitiga,hitung_volume_prisma_segitiga
...
def hitung_luasalas():
    ...
    luasalas = hitung_luas_prisma_segitiga(sisi1,sisi2,sisi3,tinggiprisma)
...
def hitung_luassisi():
    ...
    luassisi = hitung_luassisi_prisma_segitiga(sisi1,sisi2,sisi3,tinggiprisma,alas,tinggi)
...
def hitung_volume():
    ...
    volume = hitung_volume_prisma_segitiga(alas,tinggi,luas,tinggiprisma,sisi1,sisi2,sisi3)
