...
from fungsi import hitung_luas_limas_segitiga, hitung_volume_limas_segitiga
...
def hitung_luaspermukaan():
    ...
    luas = hitung_luas_limas_segitiga(alassegitiga,tinggilimas,tinggisegitiga)
...
def hitung_volume():
    ...
    Volume =  hitung_volume_limas_segitiga(alassegitiga,tinggilimas,tinggisegitiga)
